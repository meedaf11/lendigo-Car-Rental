        ...
        <div class="cars-list">
            <?php foreach ($cars as $car): ?>
                <div class="car-card" data-id="<?= $car['car_id'] ?>" data-name="<?= htmlspecialchars($car['car_name']) ?>"
                    data-img="<?= htmlspecialchars($car['image_url']) ?>" data-brand="<?= htmlspecialchars($car['brand']) ?>"
                    data-model="<?= htmlspecialchars($car['model']) ?>" data-fuel="<?= htmlspecialchars($car['car_fuel']) ?>"
                    data-places="<?= $car['places'] ?>" data-price="<?= $car['price_per_day'] ?>"
                    data-auto="<?= $car['isAutomatic'] ? 'Automatic' : 'Manual' ?>" data-rating="<?= $car['avg_rating'] ?? 'No rating' ?>"
                    data-status="<?= $car['availability_status'] ?>" data-desc="<?= htmlspecialchars($car['description']) ?>">
